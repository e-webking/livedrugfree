...
class MembershipController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * @return void
     */
    public function showAction(\Netkyngs\Nkcadportal\Domain\Model\Membership $membership)
    {
     ...
     * action create
     * 
     * @param \Netkyngs\Nkcadportal\Domain\Model\Membership $newMembership
     * @return void
     */
    public function createAction(\Netkyngs\Nkcadportal\Domain\Model\Membership $newMembership)
    {
     ...
     * 
     * @param \Netkyngs\Nkcadportal\Domain\Model\Membership $membership
     * @ignorevalidation $membership
     * @return void
     */
    public function editAction(\Netkyngs\Nkcadportal\Domain\Model\Membership $membership)
    {
        $this->view->assign('membership', $membership);
    }
     ...
     * @return void
     */
    public function updateAction(\Netkyngs\Nkcadportal\Domain\Model\Membership $membership)
    {
     ...
     * @return void
     */
    public function deleteAction(\Netkyngs\Nkcadportal\Domain\Model\Membership $membership)
    {
