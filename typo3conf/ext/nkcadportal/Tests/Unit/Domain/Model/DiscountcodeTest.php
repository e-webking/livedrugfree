...
/**
 * Test case for class \Netkyngs\Nkcadportal\Domain\Model\Discountcode.
 *
 ...
 */
class DiscountcodeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Netkyngs\Nkcadportal\Domain\Model\Discountcode
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Netkyngs\Nkcadportal\Domain\Model\Discountcode();
	}
	 ...
	 * @test
	 */
	public function getAgencyReturnsInitialValueForString()
	{
		$this->assertSame(
			'',
			$this->subject->getAgency()
		);
	}
	 ...
	 * @test
	 */
	public function setAgencyForStringSetsAgency()
	{
		$this->subject->setAgency('Conceived at T3CON10');
