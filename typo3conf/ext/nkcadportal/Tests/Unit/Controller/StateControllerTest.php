...
/**
 * Test case for class Netkyngs\Nkcadportal\Controller\StateController.
 *
...
class StateControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Netkyngs\Nkcadportal\Controller\StateController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Netkyngs\\Nkcadportal\\Controller\\StateController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllStatesFromRepositoryAndAssignsThemToView()
	{
		...
		$stateRepository = $this->getMock('Netkyngs\\Nkcadportal\\Domain\\Repository\\StateRepository', array('findAll'), array(), '', FALSE);
